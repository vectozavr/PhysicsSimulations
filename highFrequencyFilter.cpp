...
int main() {
    ...
    cross(sin_high_SPECTRA1, frequencyStep, cross_sin_high);
    ...
    cross(half_sin_low_half_sin_high_SPECTRA1, frequencyStep, cross_half_sin_low_half_sin_high);
    ...
    //gp.sendLine(R"(plot "frequencyStep_phase.dat" with lines)");
    //gp.sendLine(R"(plot "frequencyStep_transform_real.dat" with lines)");
    //gp.sendLine(R"(plot "frequencyStep_transform_image.dat" with lines)");
